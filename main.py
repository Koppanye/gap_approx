...
from two_machines import InstanceTwoMachines
import numpy as np
...
instance = InstanceTwoMachines(3,15, [3, 6, 12, 24, 17, 33, 66, 132, 264, 528, 160, 640, 576, 320, 288])
sol, C_max = instance.opt_IP()
print(f"Optimal C_max: {C_max}")
C_max_LP = instance.opt_LP(verbose=True, C_max=C_max)
print(f"Optimal C_max LP relaxation: {C_max_LP[0]}")